...
function changeSaleprice() {
  document.querySelector('#precio_de_venta').value = parseFloat(document.querySelector('#precio_de_compra')).value * parseFloat(document.querySelector('#porcentaje').value)
}
