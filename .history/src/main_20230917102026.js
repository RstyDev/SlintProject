...
async function agregarProducto(){
  greetMsgEl.textContent = ("Producto agregado: "+await invoke("agregar", { codigo: cod.value, precio: precio.value, tipoProducto: tpProd.value,marca: mark.value, variedad:variety.value, cantidad:amount.value, presentacion:pres.value }));
}
...
window.addEventListener("DOMContentLoaded", ()=>{
  ...
  precio=document.querySelector('#precio_de_venta')
