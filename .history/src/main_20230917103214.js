...
async function agregarProducto(){
  greetMsgEl.textContent = ("Producto agregado: "+await invoke("agregar", { codigo: cod.value, precio_de_venta: precio_de_venta.value,porcentaje,precio_de_costo:precio_de_costo.value, tipoProducto: tpProd.value,marca: mark.value, variedad:variety.value, cantidad:amount.value, presentacion:pres.value }));
}
...
function change_saleprice(valor){
  document.querySelector('#precio_de_venta').value=valor*document.querySelector('#porcentaje').value
}
