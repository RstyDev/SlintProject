...
function changeSaleprice() {
  console.log("a ver");
  document.querySelector('#precio_de_venta').value = Number(document.querySelector('#precio_de_compra')) * Number(document.querySelector('#porcentaje').value)
}
...
window.addEventListener("DOMContentLoaded", changeSaleprice());
