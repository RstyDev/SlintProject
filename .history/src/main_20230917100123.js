...
async function agregarProducto(tpProd,mark,variety,amount,pres,cod,precio){
  greetMsgEl.textContent = await invoke("agregar", { codigo: codtipoProducto: tpProd.value,marca: mark.value, variedad:variety.value, cantidad:amount.value, presentacion:pres.value });
}
