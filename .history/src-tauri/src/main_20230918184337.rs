...
impl Sistema{
    pub fn new_producto(&mut self,codigo:&str,
    precio_de_venta:&str,
    porcentaje:&str,
    precio_de_costo:&str,
    tipo_producto: &str,
    ...
    cantidad: &str,
    presentacion: &str){
        self.productos.push(Producto { codigo_de_barras, precio_de_venta: (), porcentaje: (), precio_de_costo: (), tipo_producto: (), marca: (), variedad: (), cantidad: () })
