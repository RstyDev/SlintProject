...
pub struct Producto {//falta agregar el codigo de proveedor en vec, los proveedores en vec, puede ser un hashmap o un vec de tuplas con referencia a una lista de proveedores
