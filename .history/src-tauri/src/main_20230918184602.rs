...
impl Sistema{
    ...
    cantidad: &str,
    presentacion: &str){
        self.productos.push(Producto { codigo_de_barras:codigo_de_barras.parse().expect(), precio_de_venta: (), porcentaje: (), precio_de_costo: (), tipo_producto: (), marca: (), variedad: (), cantidad: () })
